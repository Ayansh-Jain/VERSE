...
// Multer middleware for post image/video upload
...
// Fetch feed: posts by following first, then others, with pagination
export const getFeed = async (req, res) => {
  try {
    ...
    // IDs of users the current user follows, plus themselves
...
export const likePost = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Post updated.", likes: updatedPost.likes });
  } catch (error) {
